...
document.addEventListener("DOMContentLoaded", function () {
    ...
    buttons.forEach(function (button) {
        button.addEventListener("click", function () {
            ...
            if (semesterBooks[linkKey]) {
                link = semesterBooks[linkKey][0];
            } else {
...
// Initialize book data for 3rd semester
updateBookData(
    //  1st Semester 
    // Bio_Medical_Engineering
    "1st", "assets/image/Books/Bio_Medical_Engineering.png", "Bio Medical Engineering", "John Enderle, Joseph Bronzino", "bio_medical",
    // C_Language
    "1st", "assets/image/Books/Data_Structure_Using_C.png", "Data Structure Using C", "Reema Thareja", "Data_Structure_Using_C",
    "1st", "assets/image/Books/Let_Us_C.png", "Let Us C", "Yashavant P. Kanetkar", "Let_Us_C",
    "1st", "assets/image/Books/Programming_In_Ansi.png", "Programming In Ansi", "E Balagurusamy", "C_Language_Ansi_C",
    // ED_and_Graph
    "1st", "assets/image/Books/ED_and_Graph.png", "ED & Graph", "", "ED_and_Graph",
    // Advance_Engineering_Mathematics
    "1st", "assets/image/Books/Advance_Engineering_Mathematics.webp", "Advance Engineering Mathematics", "Erwinn Kreyszig", "Advance_Engineering_Mathematics",
    "1st", "assets/image/Books/Advance_Engineering_Mathematics_Solution.png", "Advance Engineering Mathematics Solution", "Erwinn Kreyszig", "Advance_Engineering_Mathematics_Solution",
    // Optimization_Technique
    "1st", "assets/image/Books/Optimization_Technique.png", "Optimization Technique", "Hamdy A. Taha", "Optimization_Technique",
    // Engineerig_Physics
    "1st", "assets/image/Books/Engineerig_Physics.jpg", "Engineering Physics", "B.K. Pandey, S. Chaturvedi", "Engineering_Physics",

    // 2nd Semester
    // BEE 
    "2nd", "assets/image/Books/Basic_Electrical_Engineering_VKMehta.png", "Basic Electrical Engineering", "V.K. Mehta, Rohit Mehta", "BEE_VKMehta",
    "2nd", "assets/image/Books/Electric_Circuits.png", "Electric Circuit", "MD. Nahvi, Joseph A", "BEE_Electric_Circuit",
    // English
    "2nd", "assets/image/Books/Effective_Technical_Writing.png", "Effective Technical Writing", "M Ashraf Rizvi", "Effective_Technical_Communication",
    "2nd", "assets/image/Books/Technical_Communication.webp", "Technical Writing", "Meenakshi Raman", "Technical_Communication",
    // Calculus
    "2nd", "assets/image/Books/Numerical_Analysis.png", "Numerical Analysis", "S.S Sastry", "Numerical_Analysis",
    // Chemistry
    "2nd", "assets/image/Books/Engineering_Chemistry.webp", "Engineering Chemistry", "Sekha Agarwal", "Engineering_Chemistry",
    // Workshop
    "2nd", "assets/image/Books/Workshop_Technology.webp", "Workshop Technology", "Rajendra Singh", "Workshop",


    // 3rd Semester
    // Automata_Theory_Language_and_Computation 
    "3rd", "assets/image/Books/Formal_Language_and_Automata.png", "Formal Language and Automata", "Peter Linz", "Formal_Language_and_Automata",
    "3rd", "assets/image/Books/Formal_Language_and_Automata_Solution.png", "Formal Language and Automata Solution", "Peter Linz", "Formal_Language_and_Automata_Solution",
    "3rd", "assets/image/Books/Automata_Theory_Language_and_Computation.jpg", "Automata Theory Language and Computation", "John E. Hopcroft, Rajeev Motwani", "Introduction_to_Automata_Theory",
    "3rd", "assets/image/Books/Formal_language_and_automataa.png", "Introduction to formal and Language", "Peter Linz", "Introduction_to_formal_and_Language",
    // Data_Structure
    "3rd", "assets/image/Books/Fundamentals_Of_Data_Structures.png", "Fundamental Of Data Structure", "Ellis Horowitz, Sartaj Sahni", "Fundamental_Of_Data_Structure",
    "3rd", "assets/image/Books/Data_Structure_and_Algorithm.webp", "Data Structure Algorithm", "Narasimha Karumanchi", "Data_Structure_Algorithm",

    // DSD 
    "3rd", "assets/image/Books/Digital_Design.webp", "Digital Design", "M. Morris Mano, Michael D. Cileti", "DSD_Digital_System_Design",

    // IEC
    "3rd", "assets/image/Books/Monetary_Economics.png", "Monetary Economics", "DR. R. R. Paul", "IEC_HASS_ELECTIVE-2",
    "3rd", "assets/image/Books/Economic_Development.png", "Economic Development", "Michael P. Todaro, Stephen C. Smith", "IEC_Economic_Development",

    // IND4.0
    "3rd", "assets/image/Books/Industry_Revolution.webp", "Industry Revolution", "D. Pyo. J. Hwang. Y. Yoon", "Industry_Evaluation",

    // PS 
    "3rd", "assets/image/Books/Probability_and_Static.webp", "Probability and Static", "Jay L. Devore", "Probability_and_Static",


    // 4th Semester
    // COA 
    "4th", "assets/image/Books/Computer_Organization_and_Architecture.png", "Computer Organization and Architecture", "William Stallings", "COA_Books_Computer_Organization_and_Architecture",
    "4th", "assets/image/Books/Computer_Organization_and_Embedded_System.webp", "Computer Organization and Embedded System", "Carl Hamacher, Zvonko Vranesic", "COA_Books_Computer_organization_and_embedded_systems",
    "4th", "assets/image/Books/Computer_Organization.png", "Computer Organization", "Carl Hamacher ", "COA_Books_Computer_Organization_5th_Edition",
    "4th", "assets/image/Books/Computer_Organization_KIIT.png", "Computer Organization KIIT", "Dr. G. Senthil Kumar", "COA_Books_GSK_Comp_Organisation_notes",
    "4th", "assets/image/Books/Computer_System_Architecture.png", "Computer System Architecture", "M. Morris Mano", "COA_Books_computer-system-architecture",

    // DBMS 
    "4th", "assets/image/Books/DBMS_Mc_Graw_Hill.png", "DBMS Mc Graw Hill", "Henry F. Korth", "DBMS_Book_Database_system_concepts",
    "4th", "assets/image/Books/Fundamental_of_Database_System.png", "Fundamental of Database System", "Ramez Elmasri, Shamkant B. Navathe", "DBMS_Book_Fundamentals_of_Database_Systems",
    "4th", "assets/image/Books/Guide_to_Databases.png", "Guide to Databases", "Mana Takahashi, Shoko Azuma", "DBMS_Book_The-Manga-guide-to-databases",

    // DM 
    "4th", "assets/image/Books/Discrete_Mathematics_and_its_Application.webp", "Discrete Mathematics and its Application", "Kenneth H. Rosen", "DM_Discrete_Mathematics",

    // OOP Java 
    "4th", "assets/image/Books/Java_The_Complete_Edition.webp", "Java The Complete 11th Ed.", "Herbert Schildt ", "OOP_Book_Java_The_Complete_Reference_Eleventh_Edition",
    "4th", "assets/image/Books/Java_The_Complete_Reference.png", "Java The Complete 9th Ed.", "Herbert Schildt", "OOP_Book_Java_the_Complete_Reference",
    "4th", "assets/image/Books/OOP_with_C++.webp", "Object Oriented Programming with C++", "E Balagurusamy", "OOP_Book_Object_Oriented_Programming_with_C++",

    //  OS 
    "4th", "assets/image/Books/Operating_System_Concept.webp", "Operating System Concept 9th Ed.", "Abraham Silberschatz, Peter B. Galvin", "OS_Book_01_Abraham",
    "4th", "assets/image/Books/Operating_System_Concept_10th.png", "Operating System Concept 10th Ed.", "Abraham Silberschatz, Peter B. Galvin", "OS_Book_Operating_System_Concepts",


    // 5th Semester
    // CI
    "5th", "assets/image/Books/Neuro_Fuzzy.png", "Computational Intelligence", "Jyh-Shing Roger Jang", "Computational_Intelligence",

    // AI
    "5th", "assets/image/Books/Artificial_Intelligence.webp", "Artificial Intelligence A Modern Approach", "Stuart Russell, Peter Norvig", "Artificial_Intelligence",

    // CN 
    "5th", "assets/image/Books/Computer_Network.webp", "Computer Networks ", "Behrouz A. Forouzan", "Computer_Network",

    // cryptography
    "5th", "assets/image/Books/Cryptography_and_Network_Security.webp", "Cryptography and Network Security", "Behrouz A. Forouzan", "Cryptography",

    // DAA
    "5th", "assets/image/Books/Algorithms.webp", "Introduction to Algorithms", "T. H. Cormen", "DataAnalysis_Algorithm",

    // DMDW
    "5th", "assets/image/Books/Data_Mininig.webp", "Data-Mining", "Han and Kamber", "DataMining_DataWarehousing",

    // SE
    "5th", "assets/image/Books/Software_Engineering.webp", "Fundamentals of Software Engineering", "Mall, Rajib", "Software_Engineering",


    // 6th  Semester
    // CC 
    "6th", "assets/image/Books/Cloud_Computing.webp", "CLOUD COMPUTING", "Rajkumar Buyya", "Cloud_Computing",

    // CD
    "6th", "assets/image/Books/Compiler_Design.png", "Compiler Design", "Alfred V. Aho, Monica S. Lam", "Compiler_Design",

    // DA
    "6th", "assets/image/Books/Data_Analysis.webp", "Mastering Social Media Mining", "Marco Bonzanini", "Data_Analysis",

    // IOT 
    "6th", "assets/image/Books/Interet_of_Things.webp", "Internet of Things", "Arshdeep Bahga, Vijay Madisetti", "Internet_of_Things",

    // ML 
    "6th", "assets/image/Books/Machine_Learning.webp", "Applied Machine Learning ", "M Gopal", "Machine_Learning",

    // NLP 
    "6th", "assets/image/Books/Natural_Language_Processing.webp", "Foundations of Statistical Natural Language Processing", "Christopher D. Manning", "Natural_Language_Processing",

    // SPM 
    "6th", "assets/image/Books/Software_Project_Management.webp", "Software Project Management", "Bob Hughes", "Software_Project_Management",
...
// Generate book elements for 3rd semester
