...
updateSubjectNoteData(
    ...
    // C Lab 
    "C Lab", "Computer Programming Language", "C_Language_Lab-1_computer_programming_language",
    "C Lab", "Number System", "C_Language_Lab-2_number_system",
    "C Lab", "C Operator Precedence Table", "C_Language_Lab-3_C_Operator_precedence_table",
    "C Lab", "Operator and Expression", "C_Language_Lab-3_operator_and_expression",
    "C Lab", "Control Statement", "C_Language_Lab-4_control_statement",
    "C Lab", "Control Statement", "C_Language_Lab-5_control_statement",
    "C Lab", "Control Statement", "C_Language_Lab-6_control_statement",
    "C Lab", "Control Statement", "C_Language_Lab-7_control_statement",
    "C Lab", "Array & String", "C_Language_Lab-8_array_&_string",
    "C Lab", "Array & String", "C_Language_Lab-9_array_&_string",
    "C Lab", "Array and String", "C_Language_Lab-10_array_and_string",
    "C Lab", "Multidimensional Array", "C_Language_Lab-11_multidimensional_Array",
    "C Lab", "Functions", "C_Language_Lab-12_functionsy",

    // Bio-Medical
    "Bio-Medical", "Syllabus", "Bio-Medical_Engineering_00_syllabus",
    "Bio-Medical", "Cell Structure", "Bio-Medical_Engineering_01_cell_structure",
    "Bio-Medical", "Human Body System", "Bio-Medical_Engineering_02_human_body_system",
    "Bio-Medical", "Human Nervous System", "Bio-Medical_Engineering_03_human_nervous_system",
    "Bio-Medical", "Human Respiratory System", "Bio-Medical_Engineering_04_human_respiratory_system",
    "Bio-Medical", "Action Potential", "Bio-Medical_Engineering_05_action_potential",
    "Bio-Medical", "Major Organ Systems", "Bio-Medical_Engineering_06_Major_Organ_Systems",
    "Bio-Medical", "Bio-Med", "Bio-Medical_Engineering_08_&_09_bio_med",
    "Bio-Medical", "BMI Sensors", "Bio-Medical_Engineering_11_BMI_sensors",
    "Bio-Medical", "Transducer", "Bio-Medical_Engineering_12_Transducer",
    "Bio-Medical", "EEG Class", "Bio-Medical_Engineering_13_EEG_Class",
    "Bio-Medical", "ECG Signal", "Bio-Medical_Engineering_14_ECG_signal",
    "Bio-Medical", "ECG Signal (1)", "Bio-Medical_Engineering_15_ECG_signal(1)",
    "Bio-Medical", "Medical Imaging-1", "Bio-Medical_Engineering_17_Medical_Imaging-1",
    "Bio-Medical", "Medical Imaging CT Scan", "Bio-Medical_Engineering_18_Medical_Imaging_CT_scan",
    "Bio-Medical", "Bioinformatics", "Bio-Medical_Engineering_21_Bioinformatics",
    "Bio-Medical", "Noise & Electrical Safety Issues", "Bio-Medical_Engineering_21_Noise_Electrical_safety_issues",
    "Bio-Medical", "EEG Class", "Bio-Medical_Engineering_22_EEG_Class",
    "Bio-Medical", "EMG Class", "Bio-Medical_Engineering_23_EMG_class",
    "Bio-Medical", "Medical Imaging", "Bio-Medical_Engineering_24_Medical_Imaging",

    // ED and Graph 
    "ED and Graph", "AutoCAD", "ED_and_graph_00_auto_cad",
    "ED and Graph", "EG Lesson Plan", "ED_and_graph_01_EG_lesson_plan",
    "ED and Graph", "Introduction", "ED_and_graph_01_introduction",
    "ED and Graph", "EG Questions (Updated)", "ED_and_graph_02_EG_questions_updated",
    "ED and Graph", "EG Questions", "ED_and_graph_02_EG_questions",
    "ED and Graph", "Lettering", "ED_and_graph_02_lettering",
    "ED and Graph", "Projection of Lines", "ED_and_graph_03_projection_of_lines",
    "ED and Graph", "Projection of Point and Line", "ED_and_graph_04_projection_of_point_and_line",
    "ED and Graph", "Projection of Solid", "ED_and_graph_05_projection_of_solid",
    "ED and Graph", "Projections of Plane", "ED_and_graph_06_projections_of_plane",

    // EVS 
    "EVS", "Mid-Sem Syllabus (2022)", "EVS_00_mid-sem_syllabus(2022)",
    "EVS", "Unit 01", "EVS_01_unit01",
    "EVS", "Unit 1", "EVS_01_unit1",
    "EVS", "Unit 2", "EVS_02_unit2",
    "EVS", "Unit 3", "EVS_03_unit3",
    "EVS", "Unit 4 (Green Chemistry)", "EVS_04_unit4(Green_Chemistry)",
    "EVS", "Reverse Osmosis Electrodialysis", "EVS_05_Reverse_Osmosis_Electrodialysis",
    "EVS", "Water Purification Technologies", "EVS_06_Water_Purification_Technologies",

    // Life Science
    "Life Science", "Course Handout", "LifeScience_01_course_handout",
    "Life Science", "Need of Biology for Engineering", "LifeScience_02_need_of_biology_for_engineering",
    "Life Science", "Biodiversity Microbes", "LifeScience_03_biodiversity_microbes",
    "Life Science", "Cell Structure", "LifeScience_04_cell_structure",
    "Life Science", "Chemical Basis", "LifeScience_04_chemical_basis",
    "Life Science", "Organic Compounds", "LifeScience_04_organic_compounds",
    "Life Science", "Cell Differentiation & Stem Cell", "LifeScience_05_cell_differentiation_&_stem_cell",
    "Life Science", "Protein Synthesis", "LifeScience_05_protein_synthesis",
    "Life Science", "Metabolism and Homeostasis", "LifeScience_06_Metabolism_and_Homeostasis",
    "Life Science", "Photosynthesis", "LifeScience_06_photosynthesis",
    "Life Science", "Enzymes", "LifeScience_07_enzymes",
    "Life Science", "Biosensor", "LifeScience_08_biosensor",
    "Life Science", "Molecular Machines", "LifeScience_09_Molecular_Machines",
    "Life Science", "Nervous System", "LifeScience_10_nervous_system",

    // Diff Eqn and Linear Alg 
    "Diff Eqn and Linear Alg", "Course Handout", "Diff_Eqn_and_Linear_Alg_01_Course_handout",
    "Diff Eqn and Linear Alg", "Syllabus", "Diff_Eqn_and_Linear_Alg_02_syllbus",
    "Diff Eqn and Linear Alg", "Chapter 1, Sec 1.1", "Diff_Eqn_and_Linear_Alg_Chapter-1_sec_1.1",
    "Diff Eqn and Linear Alg", "Chapter 1, Sec 1.3", "Diff_Eqn_and_Linear_Alg_Chapter-1_sec_1.3",
    "Diff Eqn and Linear Alg", "Chapter 1, Sec 1.4", "Diff_Eqn_and_Linear_Alg_Chapter-1_sec_1.4",
    "Diff Eqn and Linear Alg", "Chapter 1, Sec 1.5", "Diff_Eqn_and_Linear_Alg_Chapter-1_sec_1.5",
    "Diff Eqn and Linear Alg", "Chapter 1, Sec 1.6", "Diff_Eqn_and_Linear_Alg_Chapter-1_sec_1.6",
    "Diff Eqn and Linear Alg", "Chapter 1, Sec Modeling Problem", "Diff_Eqn_and_Linear_Alg_Chapter-1_sec_Modeling_Problem",
    "Diff Eqn and Linear Alg", "Chapter 2, Sec 2.1", "Diff_Eqn_and_Linear_Alg_Chapter-2_sec_2.1",
    "Diff Eqn and Linear Alg", "Chapter 2, Sec 2.10", "Diff_Eqn_and_Linear_Alg_Chapter-2_sec_2.10",
    "Diff Eqn and Linear Alg", "Chapter 2, Sec 2.2", "Diff_Eqn_and_Linear_Alg_Chapter-2_sec_2.2",
    "Diff Eqn and Linear Alg", "Chapter 2, Sec 2.3, 2.5 & 2.6", "Diff_Eqn_and_Linear_Alg_Chapter-2_sec_2.3,2.5&_2.6",
    "Diff Eqn and Linear Alg", "Chapter 2, Sec 2.7", "Diff_Eqn_and_Linear_Alg_Chapter-2_sec_2.7",
    "Diff Eqn and Linear Alg", "Chapter 2, Sec 2.9", "Diff_Eqn_and_Linear_Alg_Chapter-2_sec_2.9",
    "Diff Eqn and Linear Alg", "Chapter 7", "Diff_Eqn_and_Linear_Alg_Chapter-7",
    "Diff Eqn and Linear Alg", "Chapter 8, Sec 8.1(1)", "Diff_Eqn_and_Linear_Alg_Chapter-8_sec_8.1(1)",
    "Diff Eqn and Linear Alg", "Chapter 8, Sec 8.1(2)", "Diff_Eqn_and_Linear_Alg_Chapter-8_sec_8.1(2)",
    "Diff Eqn and Linear Alg", "Chapter 8, Sec 8.1, 8.3, 8.4, 8.5", "Diff_Eqn_and_Linear_Alg_Chapter-8_sec_8.1,_8.3,_8.4,_8.5",
    "Diff Eqn and Linear Alg", "Chapter 8, Sec 8.3, 8.5", "Diff_Eqn_and_Linear_Alg_Chapter-8_sec_8.3,_8.5",
    "Diff Eqn and Linear Alg", "Chapter 8, Sec 8.4", "Diff_Eqn_and_Linear_Alg_Chapter-8_sec_8.4",
    "Diff Eqn and Linear Alg", "Single Slit", "Diff_Eqn_and_Linear_Alg_single_slit",
    "Diff Eqn and Linear Alg", "Special Function", "Diff_Eqn_and_Linear_Alg_special_function",

    // Optimization Technique
    "Optimization Technique", "Introduction to OT", "Optimization_Technique_01_introduction_to_OT",
    "Optimization Technique", "Graphical Method", "Optimization_Technique_02_graphical_method",
    "Optimization Technique", "Optimization Technique", "Optimization_Technique_02_optimization_technique",

    // Physics 
    "Physics", "Course Handout", "Physics_01_course_handout",
    "Physics", "Damped Harmonic Oscillation", "Physics_02_damped_harmonic_oscillation",
    "Physics", "Forced Oscillation", "Physics_03_forced_oscillation",
    "Physics", "Coupled Oscillation", "Physics_04_coupled_oscillation",
    "Physics", "Wave and Interference", "Physics_05_wave_and_interference",
    "Physics", "Wedge Shaped Thin Film", "Physics_06_wedge_shaped_thin_film",
    "Physics", "Diffraction and Single Slit", "Physics_07_diffraction_and_single_slit",
    "Physics", "Plane Diffraction Grating", "Physics_08_Plane_diffraction_grating",
    "Physics", "Quantum Mechanics(1)", "Physics_09_Quantum_mechanics(1)",
    "Physics", "Quantum Mechanics(2)", "Physics_09_Quantum_mechanics(2)",
    "Physics", "Quantum Mechanics(3)", "Physics_09_Quantum_mechanics(3)",
    "Physics", "One-dimensional Potential Box", "Physics_10_one_dimensional_potential_box",
    "Physics", "Modified Laser", "Physics_11_laser_modified",
    "Physics", "Optical Fibre", "Physics_12_optical_fibre",
